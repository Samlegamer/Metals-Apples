...
public class MetalAppleFabric implements ModInitializer
{
    ...
    public void registerItems() {
        ...
        for(Map.Entry<String, MAApple> entry : mapVanilla.entrySet()) {
            ...
            ResourceLocation key = new ResourceLocation(MetalApple.MODID, entry.getKey());
            Registry.register(BuiltInRegistries.ITEM, key, new Item(new Item.Properties().food(MAItemsRegistry.createFoodProperties(appleConfig))));
        }
